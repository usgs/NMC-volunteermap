...
// Create cluster variables for data points// 
var markers = L.markerClusterGroup();
markers.addLayer(L.marker(myRandom(map))),
markers.addLayer(L.marker(myPeer(map))),
markers.addLayer(L.marker(myChallenge(map)));
